ICONS = ['bowling-ball', 'trash', 'crow', 'anchor', 'atom', 'baby', 'bath',
         'bomb', 'bone', 'cannabis', 'bug', 'car', 'cloud', 'coffee', 'couch', 'dog', 'fish',
         'ghost', 'glass-martini-alt', 'hammer', 'hamburger', 'head-side-cough', 'hippo', 'heartbeat',
